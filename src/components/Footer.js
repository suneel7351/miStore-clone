    ...
    <>
      ...
      <div className="preFooter2">
        ...
        <div>
          ...
          <span>Thanks.yo're email on special offers.</span>
        </div>
        <div>
          <div>
            <strong>FOLLOW MI</strong>
          </div>
      ...
      <div className="footer">
        <div className="support footer-display">
          <div className="footer-column">
            <h6>Support</h6>
            {Footer.support.map((items, index) => {
              return (
                <a href={items.url} key={items.index} alt={items.name}>
                  {items.name}
                </a>
              );
            })}
        ...
        <div className="shopLearn footer-display">
          <div className="footer-column">
        ...
        <div className="retailStore footer-display">
          <div className="footer-column">
            <h6>RETAIL STORE</h6>
        ...
        <div className="aboutUs footer-display">
          <div className="footer-column">
            <h6>ABOUT US</h6>
        ...
        <div className="contactUs footer-display">
          <div className="footer-column">
            <h6>CONTACT US</h6>
